...
console.log("CONNECTING DRINX-MD 🧬...");
...
console.log('DRINX-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ DRINX-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029VbBEGYMGJP8NpOJ6eS2A*
...
if(senderNumber.includes("50943537991")){
if(isReact) return
m.react("🦋")
   }

if(senderNumber.includes("50935959059")){
if(isReact) return
m.react("🎀")
   }
